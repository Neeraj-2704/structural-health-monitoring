...
const CircleGauge = createLucideIcon("circle-gauge", __iconNode$j);
const __iconNode$i = [
...
const ClipboardPen = createLucideIcon("clipboard-pen", __iconNode$h);
const __iconNode$g = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const OctagonAlert = createLucideIcon("octagon-alert", __iconNode$9);
const __iconNode$8 = [
...
const ThermometerSun = createLucideIcon("thermometer-sun", __iconNode$5);
const __iconNode$4 = [
  [
    "path",
    {
